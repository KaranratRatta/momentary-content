...
def generate_thumbnail(thumbnail_prompt: str, thumbnail_text: str = "", model: str | None = None, style: str | None = None, append_style: bool = False, run_dir: Path | None = None) -> str:
    if append_style:
        style_name = style or DEFAULT_STYLE
        style_prompt = STYLE_PROMPTS.get(style_name, STYLE_PROMPTS[DEFAULT_STYLE])
