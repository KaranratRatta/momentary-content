...
- Human characters: simple stick figures with round white heads, simple shapes eyes (dots, lines, hearts, etc.), no noses
- Objects/environments: detailed hand-drawn cartoon style
